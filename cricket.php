						...
						<div class="form-1" id="resetShow">
							<form name="Blog" onclick="submitblog()">
								...
								<table style="width:400;">
									<tr>
										<td>
											<h1>Batting Maestro (Virat Kohli)</h1>
										</td>
									</tr>
									<tr>
										<td><img class="img2" src="i6vk.jpg" width="500"></td>
									</tr>
									<tr>
										<td>
											<p><span>Virat Kohli</span> is an International Indian Cricketer, who is top order batsman for the Indian National Cricket team and for the Royal Challengers 
												...
												for Indian National Cricket team against Sri Lanka.
											</p>
											<h1 class="w">Quotes from Virat Kohli</h1>
											<p>"No cricket team in the world depends on one or two players. The team always plays to win."
											<p>
											<p>"Self-belief and hard work will always earn you success."
											<p>
										</td>
									</tr>
									<tr>
