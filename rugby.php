...
<!-- Banner code ----------------------------------------------->
	...
	<div class="centerWrap1"><!--Centering everything in the div-->
		<div align="center">
	...
	2018 at Estadio José Amalfitani</h2>
		  ...
		  <div class="container">
			...
			<div class="container">
				...
				<form name="rugby-form" action="rugby.php" onsubmit="return validateComment()" align="center" method="post">
					...
					<br>
					<textarea name="comment" class="loginInput" align="center" rows="4" width="100%" placeholder="Comment"></textarea>  <!-- comment-->
					<br>
